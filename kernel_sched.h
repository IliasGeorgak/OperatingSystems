...
typedef struct thread_control_block {
  ...
  PTCB* ptcb; /**< @brief A pointer to thread's PTCB */
...
/**
  ...
  An object of this type is associated to every process thread. This object
  connects a PCB with a specific TCB.
*/
typedef struct process_thread_control_block{

  TCB* tcb; /**< @brief Pointer to a specific thread */ 
  ...
  int exitval; /**< @brief The exit value of the TCB's function */

  int exited; /**< @brief A flag for the case of an exited thread */
  int detached; /**< @brief A flag for the case of a detached thread */
  CondVar exit_cv; /**< @brief A condition variable which informs the 
                    joined threads whether the specific thread has exited or not */

  int refcount; /**< @brief A counter of the joined threads. 
                    It also counts the specific thread */

  rlnode ptcb_list_node; /**< @brief Intrusive node for ptcb_list of PTCB's PCB */
